...
$targetDirectory = "C:\SailPoint\Tomcat 9.0\bin"
...
Expand-Archive -Path $env:USERPROFILE\Desktop\$zipFile -DestinationPath C:\Sailpoint\

# Copy the webapps folder from the old Tomcat to the new one
$oldWebappsFile = "C:\SailPoint\Tomcat 9.0\webapps"
$newWebappsFile = "C:\Sailpoint\apache-tomcat-9.0.109\"
...
$oldLogsFile = "C:\SailPoint\Tomcat 9.0\logs"
$newLogsFile = "C:\Sailpoint\apache-tomcat-9.0.109\"
...
[System.Environment]::SetEnvironmentVariable("CATALINA_HOME", "C:\Sailpoint\apache-tomcat-9.0.109", "Machine")
...
$targetDirectory2 = "C:\SailPoint\Tomcat 9.0\"
if (Test-Path -Path $targetDirectory -PathType Container) {
    Set-Location -Path "C:\"
